...
// Оригинальный класс: https://github.com/MRezaNasirloo/CircularProgressBar
// Данный класс отличается от оригинального класса
public class CircleProgressBar extends View {
    ...
    private int currColor = Color.DKGRAY;
    private int startColor = ContextCompat.getColor(getContext(), R.color.red);
    private int endColor = ContextCompat.getColor(getContext(), R.color.green);
    private RectF rectF;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        backgroundPaint.setColor(adjustAlpha(Color.BLACK, 0.75f));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        rectF.set(0 + strokeWidth * 2 / 2, 0 + strokeWidth * 2 / 2, min - strokeWidth * 2 / 2, min - strokeWidth * 2 / 2);
    }
